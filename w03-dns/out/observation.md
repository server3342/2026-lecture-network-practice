...
The harness line `upstream +15% vs baseline` in `bench.txt` is a sign quirk of its formatting, not an increase: upstream went from 325 to 275, a 15.4% reduction (1 - 275/325). I left `bench.py` unmodified (R2), so the printed `+15%` stays as it is.
